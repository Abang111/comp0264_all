# Q3 Synthetic Dataset Examples (3)

- Source dataset (HF): `sentence-transformers/natural-questions` (config `pair`)

- Loaded offline from: `/workspace/tbx/natural-questions/pair/train-00000-of-00001.parquet`

- Q2 adapter used: `./PartA_Q2_outputs/Q2_20260321_234822_UTC/adapter`

- Split sizes: train=500, val=200, test=500
