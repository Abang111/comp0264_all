...
- Final val loss: `1.4867889881134033`
- Best val loss: `1.4867889881134033`
...
**After SFT:**
```
The Lucknow Congress Session, held from 1 to 12 March 1916, was presided over by Sir Syed Ali Imam and later by Dr
```
...
**After SFT:**
```
The first Chipotle Mexican Grill restaurant, opened by Steve Ells in Denver, Colorado, was
```
...
**After SFT:**
```
The herbicide Agent Orange, also known as AO or simply Orange, was used by the United States military during the Vietnam War (1959–1975)
```
