...
**After SFT:**
```
I do not have access to real-time data or specific store locations, but I can tell you that Chipotle Mexican Grill was founded in 1993 by Steve Ells and has since expanded globally
```
...
**After SFT:**
```
1961-1971, Agent Orange was used by US military forces during the Vietnam War.
```
